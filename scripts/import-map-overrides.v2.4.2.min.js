!function() {
    ...
    var y, b = "import-map-override:", w = "import-map-overrides-disabled", x = "import-map-overrides-external-maps", k = "data-is-importmap-override", M = "import-map-overrides-domains", E = "allowlist:", O = "denylist:", N = document.querySelector('meta[name="importmap-type"]'), S = document.querySelector('meta[name="'.concat(M, '"]')), C = {}, U = N ? N.getAttribute("content") : "importmap";
    if (S) {
        var I = S.getAttribute("content");
        I || console.warn("Invalid ".concat(M, " meta element - content required."));
        var P = function(e) {
        ...
        0 === I.indexOf(E) ? y = !I.slice(E.length).split(",").some(P) : 0 === I.indexOf(O) ? y = I.slice(O.length).split(",").some(P) : console.log("Invalid ".concat(M, " meta content attribute - must start with ").concat(E, " or ").concat(O))
    } else
        y = !1;
    (function() {
        try {
    ...
    y = !0),
    y || function() {
        var e, t = !!N && N.hasAttribute("server-cookie"), n = !!N && N.hasAttribute("server-only");
        window.importMapOverrides = {
            ...
            getOverrideMap: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], t = {
                    ...
                    0 === l.indexOf(b) && o(l.slice(b.length), localStorage.getItem(l))
                }
                var a = _("imo", window.location != window.parent.location ? document.referrer : window.location.href);
                if (a) {
                    var u;
                    try {
                        u = JSON.parse(a)
            ...
            getDefaultMap: function() {
                return e || (e = Array.prototype.reduce.call(document.querySelectorAll('script[type="'.concat(U, '"], script[type="overridable-importmap"]')), (function(e, t) {
                    return t.hasAttribute(k) ? e : (n = t.src ? v(t.src) : Promise.resolve(JSON.parse(t.textContent)),
            ...
            getCurrentPageExternalOverrides: function() {
                var e = [];
                return document.querySelectorAll("[".concat(k, ']:not([id="import-map-overrides"])')).forEach((function(t) {
                    e.push(t.src)
                }
                )),
                e
            ...
            disableOverride: function(e) {
                ...
                return !g(t, e) && (localStorage.setItem(w, JSON.stringify(t.concat(e))),
                i(),
                !0)
            },
            ...
            addExternalOverride: function(e) {
                ...
                return !g(t, e) && (localStorage.setItem(x, JSON.stringify(t.concat(e))),
                i(),
                !0)
            },
            removeExternalOverride: function(e) {
                var t = r.getExternalOverrides();
                return !!g(t, e) && (localStorage.setItem(x, JSON.stringify(t.filter((function(t) {
                    return t !== e
                }
                )))),
                i(),
            ...
            getExternalOverrideMap: function() {
                return (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r.getExternalOverrides()).reduce((function(e, t) {
                    var n = C[t] || (C[t] = v(t));
            ...
            isExternalMapValid: function(e) {
                return (C[e] || (C[e] = v(e))).then((function() {
        ...
        function l(e) {
            setTimeout((function() {
                var t = "import-map-overrides:".concat(e)
                  , n = o ? new CustomEvent(t) : document.createEvent("CustomEvent");
                o || n.initCustomEvent(t, !0, !0, null),
                window.dispatchEvent(n)
            }
            ))
        }
        var a, u = r.getOverrideMap(), s = r.getExternalOverrides();
        if (!n) {
            var d = document.querySelector('script[type="overridable-importmap"]');
            if (!(a = d)) {
                var c = document.querySelectorAll('script[type="'.concat(U, '"]'));
                a = c ? c[c.length - 1] : null
            }
            if (d) {
                if (d.src)
                ...
                var p;
                try {
                    p = JSON.parse(d.textContent)
                } catch (e) {
                    throw Error('Invalid <script type="overridable-importmap"> - text content must be json')
                }
                a = m(r.mergeImportMap(p, u), "import-map-overrides", a),
                h()
            } else
                h(),
                Object.keys(u.imports).length > 0 && (a = m(u, "import-map-overrides", a))
        }
        function m(e, t, n) {
        ...
        function h() {
            s.length > 0 && s.forEach((function(e, t) {
    ...
    var D, A, j, L, R, q, T = {}, F = [], W = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
    function z(e, t) {
        for (var n in t)
            e[n] = t[n];
        return e
    ...
    function $(e, t, n) {
        ...
        if (arguments.length > 2 && (l.children = arguments.length > 3 ? D.call(arguments, 2) : n),
        "function" == typeof e && null != e.defaultProps)
            for (i in e.defaultProps)
                void 0 === l[i] && (l[i] = e.defaultProps[i]);
        return B(e, l, r, o, null)
    }
    ...
    function K(e) {
        (!e.__d && (e.__d = !0) && L.push(e) && !Q.__r++ || q !== A.debounceRendering) && ((q = A.debounceRendering) || R)(Q)
    }
    function Q() {
        for (var e; Q.__r = L.length; )
            ...
            e.some((function(e) {
                ...
                (l = t.__P) && (n = [],
                (r = z({}, o)).__v = o.__v + 1,
                ie(l, o, r, t.__n, void 0 !== l.ownerSVGElement, null != o.__h ? [i] : null, n, null == i ? G(o) : i, o.__h),
                le(n, o),
                o.__e != i && X(o)))
            }
            ))
    }
    function Y(e, t, n, r, o, i, l, a, u, s) {
        var d, c, p, m, f, v, h, g = r && r.__k || F, _ = g.length;
        for (n.__k = [],
        d = 0; d < t.length; d++)
            if (null != (m = n.__k[d] = null == (m = t[d]) || "boolean" == typeof m ? null : "string" == typeof m || "number" == typeof m || "bigint" == typeof m ? B(null, m, null, null, m) : Array.isArray(m) ? B(V, {
                children: m
            }, null, null, null) : m.__b > 0 ? B(m.type, m.props, m.key, null, m.__v) : m)) {
                if (m.__ = n,
                m.__b = n.__b + 1,
                ...
                ie(e, m, p = p || T, o, i, l, a, u, s),
                f = m.__e,
                (c = m.ref) && p.ref != c && (h || (h = []),
                p.ref && h.push(p.ref, null, m),
                h.push(c, m.__c || f, m)),
                null != f ? (null == v && (v = f),
                "function" == typeof m.type && null != m.__k && m.__k === p.__k ? m.__d = u = Z(m, u, e) : u = ee(e, m, p, g, f, u),
                s || "option" !== n.type ? "function" == typeof n.type && (n.__d = u) : e.value = "") : u && p.__e == u && u.parentNode != e && (u = G(p))
            }
        for (n.__e = v,
        d = _; d--; )
            null != g[d] && ("function" == typeof n.type && null != g[d].__e && g[d].__e == n.__d && (n.__d = G(r, d + 1)),
            ue(g[d], g[d]));
        if (h)
    ...
    function Z(e, t, n) {
        ...
        for (r = 0; r < e.__k.length; r++)
            (o = e.__k[r]) && (o.__ = e,
            t = "function" == typeof o.type ? Z(o, t, n) : ee(n, o, o, e.__k, o.__e, t));
        return t
    }
    ...
    function ne(e, t, n, r, o) {
        ...
        e: if ("style" === t)
            ...
            e.l || (e.l = {}),
            e.l[t + i] = n,
            n ? r || e.addEventListener(t, i ? oe : re, i) : e.removeEventListener(t, i ? oe : re, i);
    ...
    function ie(e, t, n, r, o, i, l, a, u) {
        var s, d, c, p, m, f, v, h, g, _, y, b = t.type;
        ...
        try {
            e: if ("function" == typeof b) {
                ...
                n.__c ? v = (d = t.__c = n.__c).__ = d.__E : ("prototype"in b && b.prototype.render ? t.__c = d = new b(h,_) : (t.__c = d = new H(h,_),
                d.constructor = b,
                d.render = se),
                g && g.sub(d),
                d.props = h,
                ...
                null != b.getDerivedStateFromProps && (d.__s == d.state && (d.__s = z({}, d.__s)),
                z(d.__s, b.getDerivedStateFromProps(h, d.__s))),
                p = d.props,
                m = d.state,
                c)
                    ...
                    if (null == b.getDerivedStateFromProps && h !== p && null != d.componentWillReceiveProps && d.componentWillReceiveProps(h, _),
                ...
                d.state = d.__s,
                null != d.getChildContext && (r = z(z({}, r), d.getChildContext())),
                c || null == d.getSnapshotBeforeUpdate || (f = d.getSnapshotBeforeUpdate(p, m)),
                y = null != s && s.type === V && null == s.key ? s.props.children : s,
                Y(e, Array.isArray(y) ? y : [y], t, n, r, o, i, l, a, u),
                d.base = t.__e,
                t.__h = null,
                d.__h.length && l.push(d),
                v && (d.__E = d.__ = null),
                ...
                t.__e = n.__e) : t.__e = function(e, t, n, r, o, i, l, a) {
                    var u, s, d, c = n.props, p = t.props, m = t.type, f = 0;
                    if ("svg" === m && (o = !0),
                    null != i)
                        for (; f < i.length; f++)
                            if ((u = i[f]) && (u === e || (m ? u.localName == m : 3 == u.nodeType))) {
                                e = u,
                                i[f] = null;
                                break
                            }
                    ...
                    if (null === m)
                        c === p || a && e.data === p || (e.data = p);
                    else {
                        if (i = i && D.call(e.childNodes),
                        s = (c = n.props || T).dangerouslySetInnerHTML,
                        d = p.dangerouslySetInnerHTML,
                        !a) {
                            if (null != i)
                                for (c = {},
                                f = 0; f < e.attributes.length; f++)
                                    c[e.attributes[f].name] = e.attributes[f].value;
                            (d || s) && (d && (s && d.__html == s.__html || d.__html === e.innerHTML) || (e.innerHTML = d && d.__html || ""))
                        }
                        if (function(e, t, n, r, o) {
                            var i;
                            for (i in n)
                                "children" === i || "key" === i || i in t || ne(e, i, null, n[i], r);
                            for (i in t)
                                o && "function" != typeof t[i] || "children" === i || "key" === i || "value" === i || "checked" === i || n[i] === t[i] || ne(e, i, t[i], n[i], r)
                        }(e, p, c, o, a),
                        d)
                            t.__k = [];
                        else if (f = t.props.children,
                        Y(e, Array.isArray(f) ? f : [f], t, n, r, o && "foreignObject" !== m, i, l, i ? i[0] : n.__k && G(n, 0), a),
                        null != i)
                            for (f = i.length; f--; )
                                null != i[f] && J(i[f]);
                        a || ("value"in p && void 0 !== (f = p.value) && (f !== e.value || "progress" === m && !f) && ne(e, "value", f, c.value, !1),
                        "checked"in p && void 0 !== (f = p.checked) && f !== e.checked && ne(e, "checked", f, c.checked, !1))
                    }
                    return e
                }(n.__e, t, n, r, o, i, l, u);
            (s = A.diffed) && s(t)
    ...
    function ue(e, t, n) {
        ...
        if (r = e.__k)
            for (o = 0; o < r.length; o++)
                r[o] && ue(r[o], t, "function" != typeof e.type);
        n || null == e.__e || J(e.__e),
        e.__e = e.__d = void 0
    }
    function se(e, t, n) {
    ...
    function de(e, t, n) {
        ...
        i = [],
        ie(t, e = (!r && n || t).__k = $(V, null, [e]), o || T, T, void 0 !== t.ownerSVGElement, !r && n ? [n] : o ? null : t.firstChild ? D.call(t.childNodes) : null, i, !r && n ? n : o ? o.__e : t.firstChild, r),
        le(i, e)
    }
    D = F.slice,
    A = {
    ...
    H.prototype.setState = function(e, t) {
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = z({}, this.state),
    ...
    var ce = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(c(e = n.call.apply(n, [this].concat(i))), "getInitialOverrideUrl", (function() {
            ...
            o(c(e), "inputEl", null),
            o(c(e), "moduleNameEl", null),
            o(c(e), "handleInputRef", (function(t) {
                e.inputEl = t
            }
            )),
            o(c(e), "handleModuleNameRef", (function(t) {
                e.moduleNameEl = t
            }
            )),
            o(c(e), "dialogRef", (function(t) {
                e.dialogEl = t
            }
            )),
            o(c(e), "handleSubmit", (function(t) {
                t.preventDefault(),
            ...
            o(c(e), "getDerivedUrl", (function() {
                var t = e.props.module.isNew ? e.state.moduleName : e.props.module.moduleName;
                return pe.test(e.state.overrideUrl) ? window.importMapOverrides.getUrlFromPort(t, e.state.overrideUrl) : e.state.overrideUrl
            }
            )),
            o(c(e), "keyDown", (function(t) {
                "Escape" === t.key && (t.stopPropagation(),
                e.props.cancel())
            }
            )),
            o(c(e), "focusFirstInput", (function() {
                (e.moduleNameEl || e.inputEl).select()
            }
            )),
            o(c(e), "clearModuleName", (function() {
                e.setState({
                    moduleName: ""
                }, (function() {
                    e.focusFirstInput()
        ...
        return r(l, [{
            ...
            value: function(e) {
                ...
                }, n.moduleName), $("table", null, $("tbody", null, !n.isNew && $("tr", null, $("td", null, "Default URL:"), $("td", null, n.defaultUrl)), n.isNew && $("tr", null, $("td", null, $("span", {
                ...
                }, $("div", null, "ⓧ")))), pe.test(this.state.overrideUrl) && $("tr", null, $("td", null, "Derived url:"), $("td", null, this.getDerivedUrl())))), $("div", {
                ...
                }, "Cancel"), this.props.module.overrideUrl && !this.props.module.disabled && $("button", {
                    type: "button",
                    onClick: function() {
                ...
                }, this.props.module.disabled ? "Enable" : "Disable", " Override"), $("button", {
                    type: "submit",
                    tabIndex: 7,
      ...
      , me = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(c(e = n.call.apply(n, [this].concat(i))), "state", {
        ...
        return r(l, [{
            ...
            value: function() {
                ...
                }, this.props.dialogExternalMap.isNew ? "Add External Import Map" : "Edit External Import Map"), $("div", {
                    style: {
                        marginBottom: "20px"
                    }
                }, $("label", {
                    htmlFor: "external-importmap-url"
                }, "URL to import map:"), $("span", {
                    style: {
                        position: "relative"
                    }
                }, $("input", {
      ...
      , fe = function(e) {
        ...
        return r(o, [{
            key: "componentDidMount",
            value: function() {
                window.importMapOverrides.getCurrentPageMap().then(ge)
            }
        }, {
            key: "render",
            value: function() {
    ...
    function ge(e) {
        Object.keys(e.imports).filter((function(e) {
            ...
            window.importMapOverrides.addOverride(t, he[t](e.imports[t]))
        }
        ))
    }
    function _e() {
    ...
    var ye = function(e) {
        ...
        function l() {
            ...
            o(c(e), "reload", (function(e) {
                e.stopPropagation(),
                window.location.reload()
            }
            )),
            o(c(e), "cancel", (function() {
                e.setState({
                    dialogModule: null,
                    dialogExternalMap: null
                })
            ...
            o(c(e), "updateModuleUrl", (function(t) {
            ...
            o(c(e), "addNewModule", (function(t, n) {
            ...
            o(c(e), "filterModuleNames", (function(t) {
        ...
        return r(l, [{
            ...
            value: function(e, t) {
                ...
                }), this.dialogContainer)) : t.dialogModule && !this.state.dialogModule && (de(null, this.dialogContainer),
                ...
                de($(me, {
                    ...
                    cancel: this.cancel
                }), this.dialogContainer)) : t.dialogExternalMap && !this.state.dialogExternalMap && (de(null, this.dialogContainer),
                this.dialogContainer.remove(),
                delete this.dialogContainer)
            }
        }, {
            ...
            value: function() {
                ...
                s.filter(this.filterModuleNames).forEach((function(s) {
                    ...
                    c.disabled ? r.push(c) : u[s] ? e.state.currentPageMap.imports[s] === u[s] ? he[s] && he[s](e.state.currentPageMap.imports[s]) === u[s] ? a.push(c) : t.push(c) : n.push(c) : e.state.notOverriddenMap.imports[s] === e.state.currentPageMap.imports[s] ? o.push(c) : e.state.notOverriddenMap.imports[s] === e.state.nextPageMap.imports[s] ? l.push(c) : i.push(c)
                }
                )),
                ...
                return $("div", {
                ...
                }, "Reset all overrides"))), $("table", {
                    className: "imo-overrides-table"
                }, $("thead", null, $("tr", null, $("th", null, "Module Status"), $("th", null, "Module Name"), $("th", null, "Domain"), $("th", null, "Filename"))), $("tbody", null, n.map((function(t) {
                    return $("tr", {
                        role: "button",
                        tabIndex: 0,
                        onClick: function() {
                    ...
                    }), $("div", null, "Inline Override"), $("div", {
                        className: "imo-needs-refresh"
                    })), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )), l.map((function(t) {
                    return $("tr", {
                        role: "button",
                    ...
                    }), $("div", null, "Override disabled")), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )), t.map((function(t) {
                    return $("tr", {
                        role: "button",
                    ...
                    }), $("div", null, "Inline Override")), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )), i.map((function(t) {
                    return $("tr", {
                        role: "button",
                    ...
                    }), $("div", null, "External Override")), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )), a.map((function(t) {
                    return $("tr", {
                        role: "button",
                    ...
                    }), $("div", null, "Dev Lib Override")), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )), o.map((function(t) {
                    return $("tr", {
                        role: "button",
                    ...
                    }), $("div", null, "Default")), $("td", null, t.moduleName), $("td", null, xe(t)), $("td", null, ke(t)))
                }
                )))), (p.length > 0 || m.length > 0 || f.length > 0) && $("table", {
                    className: "imo-overrides-table"
                }, $("thead", null, $("th", null, "Import Map Status"), $("th", null, "URL")), $("tbody", null, p.map((function(t) {
                    return $("tr", {
                        role: "button",
                        tabIndex: 0,
                        onClick: function() {
                    ...
                    return $("tr", {
                        ...
                        className: "imo-status imo-next-override"
                    }), $("div", null, "Pending refresh")), $("td", null, t))
                }
                )), m.map((function(t) {
                    return $("tr", {
                        role: "button",
    ...
    var we = document.querySelector("base") && document.querySelector("base").href || location.origin + "/";
    function xe(e) {
        var t = Me(e)
          , n = Ee(t);
        return n ? n.host : t
    ...
    var Oe = function(e) {
        ...
        function l() {
            ...
            for (var r = arguments.length, i = new Array(r), a = 0; a < r; a++)
                i[a] = arguments[a];
            return o(c(e = n.call.apply(n, [this].concat(i))), "doUpdate", (function() {
                return e.forceUpdate()
            }
            )),
            o(c(e), "keydownListener", (function(t) {
        ...
        return r(l, [{
            ...
            value: function(e) {
                ...
                }, $("div", null, $("h1", null, "Import Map Overrides"), $("p", null, "This developer tool allows you to view and override your import maps. Start by clicking on a module that you'd like to override.", " ", $("a", {
                    target: "_blank",
                    href: "https://github.com/joeldenning/import-map-overrides"
                }, "See documentation for more info"), ".")), $("button", {
      ...
      , Ne = function(e) {
        ...
        function l() {
            ...
            o(c(e), "importMapChanged", (function() {
                e.forceUpdate()
            }
            )),
            o(c(e), "useDevLibs", (function() {
                var t = localStorage.getItem("import-map-overrides-dev-libs");
                return t ? "true" === t : e.props.customElement.hasAttribute("dev-libs")
            }
            )),
            o(c(e), "atLeastOneOverride", (function() {
                return e.useDevLibs() ? _e() : Object.keys(window.importMapOverrides.getOverrideMap().imports).length > 0
            }
            )),
            e
        }
        return r(l, [{
            ...
            key: "render",
            value: function(e, t) {
                return e.customElement.hasAttribute("show-when-local-storage") && "true" !== localStorage.getItem(e.customElement.getAttribute("show-when-local-storage")) ? null : $("div", null, $("button", {
                    onClick: this.toggleTrigger,
                    className: "imo-unstyled imo-trigger ".concat(this.atLeastOneOverride() ? "imo-current-override" : "")
                }, "{···}"), this.useDevLibs() && $(fe, null), t.showingPopup && $(Oe, {
    ...
    window.customElements && !y && (window.customElements.define("import-map-overrides-full", Se(Ne, ["show-when-local-storage"])),
    window.customElements.define("import-map-overrides-popup", Se(Oe)),
    window.customElements.define("import-map-overrides-list", Se(ye)))
}();
