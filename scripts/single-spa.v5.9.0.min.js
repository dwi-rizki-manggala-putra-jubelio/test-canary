System.register([], (function(t) {
    ...
    return {
        execute: function() {
            ...
            function f(t, n) {
                for (var e = arguments.length, r = new Array(e > 2 ? e - 2 : 0), o = 2; o < e; o++)
                    r[o - 2] = arguments[o];
            ...
            function l(t, n, e) {
                var r, o = "".concat(S(n), " '").concat(A(n), "' died in status ").concat(n.status, ": ");
            ...
            function D(t) {
                ...
                Array.isArray(n) && !U(n, (function(t) {
            ...
            function L(t, n) {
                return Promise.resolve().then((function() {
                    ...
                    t.bootstrap ? q(t, "bootstrap").then(e).catch((function(e) {
                        if (n)
                            throw l(e, t, T);
                        return a(e, t, T),
                        t
            ...
            function B(t, n) {
                return Promise.resolve().then((function() {
                    return t.status !== v ? t : (I || (window.dispatchEvent(new i("single-spa:before-first-mount")),
                    I = !0),
                    q(t, "mount").then((function() {
                        return t.status = g,
                        x || (window.dispatchEvent(new i("single-spa:first-mount")),
                        x = !0),
                        t
                    }
                    )).catch((function(e) {
            ...
            function $(t, n) {
                ...
                if ("object" !== e(n))
                    throw Error(f(4, !1, name, e(n)));
                if (!n.domElement)
                    throw Error(f(5, !1, name));
                var o, i = G++, u = "function" == typeof t, a = u ? t : function() {
                ...
                , c = {
                    ...
                    unmountThisParcel: function() {
                        return y.then((function() {
                            if (c.status !== g)
                                throw Error(f(6, !1, name, c.status));
                            return R(c, !0)
                        }
                        )).then((function(t) {
                            return c.parentName && delete r.parcels[c.id],
                            t
                        }
                        )).then((function(t) {
                            return p(t),
                ...
                if (!s || "function" != typeof s.then)
                    throw Error(f(7, !1));
                var p, d, w = (s = s.then((function(t) {
                    if (!t)
                        throw Error(f(8, !1));
                    var n = t.name || "parcel-".concat(i);
                    if (Object.prototype.hasOwnProperty.call(t, "bootstrap") && !D(t.bootstrap))
                        throw Error(f(9, !1, n));
                    if (!D(t.mount))
                        throw Error(f(10, !1, n));
                    if (!D(t.unmount))
                        throw Error(f(11, !1, n));
                    if (t.update && !D(t.update))
                        throw Error(f(12, !1, n));
                    var e = M(t, "bootstrap")
                      , r = M(t, "mount")
                      , u = M(t, "unmount");
                    c.status = m,
                    ...
                    t.update && (c.update = M(t, "update"),
                    o.update = function(t) {
                        return c.customProps = t,
                        k(function(t) {
                            return Promise.resolve().then((function() {
                                if (t.status !== g)
                                    throw Error(f(32, !1, A(t)));
                                return t.status = E,
                                q(t, "update").then((function() {
                                    return t.status = g,
                                    t
                                }
                                )).catch((function(n) {
                ...
                return o = {
                    mount: function() {
                        return k(Promise.resolve().then((function() {
                            if (c.status !== v)
                                throw Error(f(13, !1, name, c.status));
                            return r.parcels[i] = c,
                            B(c)
                        }
                        )))
                    },
            ...
            function K(t) {
                ...
                ("object" !== e(o) || null === o || Array.isArray(o)) && (o = {},
                console.warn(f(40, !1), r, o));
                var i = _({}, o, {
                    name: r,
                    mountParcel: $.bind(t),
                    singleSpa: n
                });
                return N(t) && (i.unmountSelf = t.unmountThisParcel),
                i
            }
            var F = {
                bootstrap: {
                ...
                return new Promise((function(i, u) {
                    ...
                    function l(t) {
                        if (!a)
                            if (!0 === t)
                                c = !0,
                                e.dieOnTimeout ? u(Error(s)) : console.error(s);
                            else if (!c) {
                                var n = t
                                  , o = n * r;
                                console.warn(s),
                                o + r < e.millis && setTimeout((function() {
                                    return l(n + 1)
                                }
                                ), r)
                            }
            ...
            function X(t) {
                return Promise.resolve().then((function() {
                    return t.loadPromise ? t.loadPromise : t.status !== p && t.status !== O ? t : (t.status = h,
                    t.loadPromise = Promise.resolve().then((function() {
                        var o = t.loadApp(K(t));
                        if (!j(o))
                            throw r = !0,
                            Error(f(33, !1, A(t)));
                        return o.then((function(r) {
                            ...
                            if (o) {
                                ...
                                return console.error(f(o, !1, i, A(t), u), n),
                                a(void 0, t, T),
                                t
                            }
                            return n.devtools && n.devtools.overlays && (t.devtools.overlays = _({}, t.devtools.overlays, n.devtools.overlays)),
                            t.status = m,
                        ...
                        var e;
                        return delete t.loadPromise,
                        r ? e = T : (e = O,
                        t.loadErrorTime = (new Date).getTime()),
                        a(n, t, e),
                        t
                    }
                    )));
            ...
            var Y, Z = "undefined" != typeof window, tt = {
                hashchange: [],
                popstate: []
            ...
            function it(t, n) {
                return function() {
                    ...
                    return Y && e === o || (Gt() ? window.dispatchEvent(ut(window.history.state, n)) : Rt([])),
                    r
                }
            }
            function ut(t, n) {
                ...
                return e.singleSpa = !0,
                e.singleSpaTrigger = n,
                e
            }
            if (Z) {
                ...
                window.addEventListener = function(t, n) {
                    if (!("function" == typeof n && nt.indexOf(t) >= 0) || U(tt[t], (function(t) {
                        return t === n
                    }
                    )))
            ...
            function mt(t) {
                return Promise.resolve().then((function() {
                    var n = ht[A(t)];
                    return n ? t.status === p ? (dt(t, n),
                    t) : "UNLOADING" === t.status ? n.promise.then((function() {
                        return t
                    }
                    )) : t.status !== v ? t : (t.status = "UNLOADING",
                    q(t, "unload").then((function() {
                        return dt(t, n),
                        t
                    }
                    )).catch((function(e) {
            ...
            function Pt(t, n, r, o) {
                var i = function(t, n, r, o) {
                    ...
                    u.customProps = t.customProps) : (function(t, n, e, r) {
                    ...
                    u.activeWhen = r,
                    u.customProps = o),
                    u.loadApp = "function" != typeof (i = u.loadApp) ? function() {
                ...
                if (-1 !== Ot().indexOf(i.name))
                    throw Error(f(21, !1, i.name));
                gt.push(_({
                    loadErrorTime: null,
                    status: p,
                    parcels: {},
            ...
            function Nt(t) {
                ...
                St(e, o.resolve, o.reject)) : r = new Promise((function(t, n) {
                    vt(e, (function() {
                        return r
                    }
                    ), t, n),
            ...
            function Rt() {
                ...
                var e, o = Et(), u = o.appsToUnload, a = o.appsToUnmount, c = o.appsToLoad, s = o.appsToMount, f = !1, l = jt, h = jt = window.location.href;
                return Gt() ? (Dt = !0,
                e = u.concat(c, a, s),
                w()) : (e = c,
                d());
                ...
                function w() {
                    return Promise.resolve().then((function() {
                        if (window.dispatchEvent(new i(0 === e.length ? "single-spa:before-no-app-change" : "single-spa:before-app-change",O(!0))),
                        window.dispatchEvent(new i("single-spa:before-routing-event",O(!0, {
                            cancelNavigation: m
                        }))),
                        f)
                            return window.dispatchEvent(new i("single-spa:before-mount-routing-event",O(!0))),
                            E(),
                            void et(l);
                        var n = u.map(mt)
                        ...
                        return o.catch((function(t) {
                            ...
                            return y(),
                            Promise.all(p.concat(h)).catch((function(n) {
                ...
                function O() {
                    var t, o = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], i = arguments.length > 1 ? arguments[1] : void 0, m = {}, d = (r(t = {}, g, []),
                    r(t, v, []),
                    r(t, p, []),
                    r(t, T, []),
                    t);
            ...
            function It(t, n) {
                return b(t) ? L(t).then((function(t) {
            ...
            function Bt(t) {
                var n;
                xt = !0,
                t && t.urlRerouteOnly && (n = t.urlRerouteOnly,
                Y = n),
                Z && Rt()
            }
            function Gt() {
