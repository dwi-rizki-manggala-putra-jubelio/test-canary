!function() {
    ...
    function f(e, t, n, r) {
        if (e.onload(n, t.id, t.d && t.d.map(a), !!r),
        n)
            throw n
    }
    function l(t, n, r) {
        ...
        var u = Promise.resolve().then((function() {
            ...
            if (!r)
                throw Error(e(2, "Module " + n + " did not instantiate"));
        ...
        [].forEach.call(document.querySelectorAll("script"), (function(t) {
            if (!t.sp)
                if ("systemjs-module" === t.type) {
                    ...
                    t.sp = !0;
                    var i = t.src ? (System.fetch || fetch)(t.src, {
    ...
    var h, p = "undefined" != typeof Symbol, v = "undefined" != typeof self, m = "undefined" != typeof document, g = v ? self : global;
    if (m) {
    ...
    var S, b = p && Symbol.toStringTag, E = p ? Symbol() : "@", O = c.prototype;
                ...
                return t.C = function e(t, n, r, i) {
                    if (!i[n.id])
                        ...
                        Promise.resolve(n.L).then((function() {
                            return n.p && null !== n.p.e || (n.p = r),
                            Promise.all(n.d.map((function(n) {
                                return e(t, n, r, i)
                            }
                            )))
                        }
    ...
    g.System = new c;
    var j, P, M = Promise.resolve(), L = {
        imports: {},
        scopes: {},
        depcache: {},
        integrity: {}
    }, C = m;
    if (O.prepareImport = function(e) {
        return (C || e) && (d(),
        C = !1),
        M
    }
    ...
    O.createScript = function(e) {
        ...
        t.async = !0,
        e.indexOf(R + "/") && (t.crossOrigin = "anonymous");
        var n = L.integrity[e];
    ...
    O.resolve = function(n, r) {
        return u(L, t(n, r = r || h) || n, r) || function(t, n) {
    ...
    O.instantiate = function(e, t) {
        ...
        if (n)
            for (var r = 0; n.length > r; r++)
                l(this, this.resolve(n[r], e), e);
        return _.call(this, e, t)
    }
    ,
    v && "function" == typeof importScripts && (O.instantiate = function(e) {
        var t = this;
    ...
    function(e) {
        ...
        t.fetch = function(t, r) {
            return u(t, r).then((function(u) {
                if (r.passThrough)
                    return u;
                if (!u.ok)
                    return u;
                var c = u.headers.get("content-type");
                return i.test(c) ? u.json().then((function(e) {
                    return new Response(new Blob(['System.register([],function(e){return{execute:function(){e("default",' + JSON.stringify(e) + ")}}})"],{
                        type: "application/javascript"
                    }))
                }
                )) : o.test(c) ? u.text().then((function(e) {
                ...
                )) : s.test(c) ? (WebAssembly.compileStreaming ? WebAssembly.compileStreaming(u) : u.arrayBuffer().then(WebAssembly.compile)).then((function(n) {
    ...
    O.set = function(t, n) {
        ...
        var r;
        k && "Module" === n[k] ? r = n : (r = Object.assign(Object.create(null), n),
        k && Object.defineProperty(r, k, {
            value: "Module"
        }));
    ...
    O.entries = function() {
        var e, t, n = this, r = Object.keys(n[E]), i = 0, o = {
            next: function() {
